...
// Stub function declarations. They are only CALLED inside
// #ifndef WITHOUT_OPENAL blocks in cellMic.cpp, so no implementation
// is required — but declaring them lets the .h compile cleanly.
